...
import { initializeApp } from "firebase/app"; // ✅ correct spelling
...
const firebaseConfig = {
  ...
  storageBucket: "gymworkoutapp-85d1e.appspot.com", // ❌ You had `.app`, should be `.appspot.com`
...
export const googleProvider = new GoogleAuthProvider(); // ✅ added () to call constructor
